...
class BackgroundService {
	...
	public const DEFAULT_BACKGROUND_IMAGE = 'plane.webp';
	...
	public const SHIPPED_BACKGROUNDS = [
		...
		'plane.webp' => [
			'attribution' => 'Plane (Yurij - CC-BY-SA-4.0)',
			'description' => 'Blue sky photo with a white plane trail',
			'attribution_url' => 'https://arche-g.org/',
			'dark_variant' => 'plane-dark.webp',
			'background_color' => self::DEFAULT_BACKGROUND_COLOR,
			'primary_color' => self::DEFAULT_COLOR,
		],
